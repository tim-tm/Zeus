...
public class NetworkManager extends SimpleChannelInboundHandler<Packet>
{
    ...
    protected void channelRead0(ChannelHandlerContext p_channelRead0_1_, Packet p_channelRead0_2_) throws Exception
    {
        ...
        {
            EventPacket packet = new EventPacket(p_channelRead0_2_, EventPacket.State.RECEIVE);
            packet.call();
            if (packet.isCancelled()) return;
            p_channelRead0_2_ = packet.getPacket();
    ...
    {
        EventPacket packet = new EventPacket(packetIn, EventPacket.State.SEND);
        packet.call();
        if (packet.isCancelled()) return;
