...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public void run()
    {
        ...
        this.zeusClient.configManager.load(DefaultConfig.class);
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Zeus - " + Zeus.VERSION);
    ...
    {
        EventResize eventResize = new EventResize(Math.max(1, width), Math.max(1, height));
        EventManager.register(eventResize);
        this.displayWidth = eventResize.getWidth();
        this.displayHeight = eventResize.getHeight();
    ...
    public void runTick() throws IOException
    {
        ...
        tickEvent.call();
        if (tickEvent.isCancelled()) return;
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                        this.zeusClient.moduleManager.handleKey(k);
