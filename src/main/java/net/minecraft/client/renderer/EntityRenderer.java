...
import me.tim.features.module.impl.render.NoCameraClip;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (movingobjectposition != null)
                    {
                        ...
                        if (d7 < d3 && !Statics.getZeus().moduleManager.getModuleByClass(NoCameraClip.class).isEnabled())
                        {
                            d3 = d7;
                        }
                    }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        eventRender3D.call();
        if (eventRender3D.isCancelled()) return;
