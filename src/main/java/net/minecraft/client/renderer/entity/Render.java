...
public abstract class Render<T extends Entity> implements IEntityRenderer
{
    ...
    protected void renderName(T entity, double x, double y, double z)
    {
        ...
        {
            this.renderLivingLabel(entity, Statics.getZeus().friendManager.contains(entity.getName()) ? Statics.getZeus().friendManager.getAlias(entity.getName()) : entity.getDisplayName().getFormattedText(), x, y, z, 64);
        }
    }
